...
public class OfflineRunner implements AnalysisListener {
    ...
    if (System.getProperty("fastqc.single_group") != null) {
			fileGroups = new File [1][files.size()];
			for (int f=0;f<files.size();f++) {
				fileGroups[0][f] = files.elementAt(f);
			}
    }
    else if (System.getProperty("fastqc.casava") != null && System.getProperty("fastqc.casava").equals("true")) {
